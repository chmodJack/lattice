...
-- Netlist created on Sat Apr 20 23:52:30 2019
-- Netlist written on Sat Apr 20 23:52:38 2019
...
-- entity led
  ...
  begin
    led_7_I: led_7_B
      port map (PADDO=>led_c_c, led7=>led(7));
    led_6_I: led_6_B
      port map (PADDO=>led_c_c, led6=>led(6));
    led_5_I: led_5_B
      port map (PADDO=>n3_c, led5=>led(5));
    led_4_I: led_4_B
      port map (PADDO=>n3_c, led4=>led(4));
    led_3_I: led_3_B
      port map (PADDO=>n5_c, led3=>led(3));
    led_2_I: led_2_B
      port map (PADDO=>n5_c, led2=>led(2));
    led_1_I: led_1_B
      port map (PADDO=>n7_c, led1=>led(1));
    led_0_I: led_0_B
      port map (PADDO=>n7_c, led0=>led(0));
    key_3_I: key_3_B
      port map (PADDI=>led_c_c, key3=>key(3));
    key_2_I: key_2_B
      port map (PADDI=>n3_c, key2=>key(2));
    key_1_I: key_1_B
      port map (PADDI=>n5_c, key1=>key(1));
    key_0_I: key_0_B
      port map (PADDI=>n7_c, key0=>key(0));
    VHI_INST: VHI
      port map (Z=>VCCI);
    PUR_INST: PUR
      port map (PUR=>VCCI);
