...
-- Netlist created on Sat Apr 20 21:48:15 2019
-- Netlist written on Sat Apr 20 21:48:34 2019
...
-- entity led
  ...
  begin
    ...
    key_3_I: key_3_B
      port map (PADDI=>n2_c, key3=>key(3));
    key_2_I: key_2_B
      port map (PADDI=>n3_c, key2=>key(2));
    key_1_I: key_1_B
      port map (PADDI=>n4_c, key1=>key(1));
    key_0_I: key_0_B
      port map (PADDI=>n5_c, key0=>key(0));
    sw_3_I: sw_3_B
      port map (PADDI=>led_c_3_c, sw3=>sw(3));
    sw_2_I: sw_2_B
